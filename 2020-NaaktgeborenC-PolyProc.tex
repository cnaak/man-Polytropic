...
\section{Requisites for Exact Polytropic Processes}
    ...
    the process, as experimental results associated with the real  gas  equation  of  state  are
    generalized for $Z$ written in terms of any pair of the corresponding reduced  property  set
    $\{P_r,       T_r,       v_r\}$---recall       the        generalized        compressibility
