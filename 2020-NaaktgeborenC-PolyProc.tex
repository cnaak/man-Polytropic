...
\section{Exact and Local Polytropic Processes}
    ...
    herein defined, to be employed as \emph{discrete building blocks}  for  general  engineering
    ...
    Since non-instantaneous, unsteady addition of heat in an  Otto  cycle  invariably  leads  to
    simultaneous heat and work interactions, resulting in non-trivial  thermodynamic  processes,
