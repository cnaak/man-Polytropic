...
\section{Requisites for Exact Polytropic Processes}
    ...
    \end{align}
    %
    \noindent yields $\mathsf{c_1} = 1$, $\mathsf{c_2} = 0$, with $\mathsf{c_3} = 1$ being the
    only possibility for constancy in $v$ terms. This result finally fixed the subtance equation
    of state by fixing $f(x)$ as
    %
    \begin{equation}
        f(v) = v.
        \label{eq:f}
    ...
    Consequently, the $Pf(v) = RT$ equation of state exactly recovers the ideal gas equation of
    state!
