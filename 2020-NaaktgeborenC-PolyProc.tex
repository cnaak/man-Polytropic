...
\section{Summary and Conclusions}
    ...
    blocks in general process modeling, which has  been  published  by  the  author  before  the
    present formalization of concepts,  is  referenced~\cite{2017-NaaktgeborenC-IntJMechEngEduc}
    in Section~\ref{sec:local} as success case for Proposition~\ref{prop:proc.model}.
    ...
    occurence of exact polytropic processes.
