...
% Article title
\PaperTitle{On Exact and Locally Polytropic Processes: Etymology, Modeling, and Requisites}
...
\Remarks{%
    ...
    Presents a statement for \emph{locally polytropic process} ---
...
\Abstract{%
    ...
    `locally' polytropic process, are herein provided.  The  proposition  of  employing  locally
    ...
    the underlying substance, are discussed beyond current literature.
}
%-----------------------------------------------------------------------------------------------
\begin{document}
%-----------------------------------------------------------------------------------------------
...
\section{Exact and Locally Polytropic Processes}
    ...
    \begin{conjecture}[general approximability]\label{conj:gen.approx}
        ...
        within a finite degree of precision by a finite set of locally polytropic processes.
    \end{conjecture}
    ...
    complexity stated on the general approximability conjecture.\vspace{1ex}
