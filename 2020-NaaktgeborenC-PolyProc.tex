...
\section{Exact and Locally Polytropic Processes}
    ...
    \begin{example}\label{ex:ideal.Diesel}
        ...
        only logical processes. One such division is: (i)~``isentropic  compression'',  ($\Delta
        s\!=\!0  \therefore  Q\!=\!0$,  $W\!\!<\!0$),  (ii)~``isobaric  heating'',   ($Q\!>\!0$,
        $\Delta P\!=\!0 \therefore W\!\!>\!0$), (iii)~``isentropic expansion'', ($\Delta s\!=\!0
        \therefore Q\!=\!0$, $W\!\!>\!0$), and (iv)~``isochoric cooling'',  ($Q\!<\!0$,  $\Delta
        v\!=\!0  \therefore  W\!\!=\!0$),  which  correspond,  respectively,  to  the  ``1--2'',
        ``2--3'', ``3--4'', and ``4--1'' processes, i.e., to the canonical  processes  for  this
        cycle. Other possible division  is:  (a)~``isentropic  compression'',  ($\Delta  s\!=\!0
        \therefore     Q\!=\!0$,      $W\!\!<\!0$),      (b)~``no-heat-removal      expansion'',
        ($Q\!\geqslant\!0$, $W\!\!>\!0$), for the ``2--4'' (through ``3''), and  (c)~``isochoric
        cooling'',  ($Q\!<\!0$,  $\Delta  v\!=\!0  \therefore  W\!\!=\!0$),  which   correspond,
        respectively, to the ``1--2'', ``2--4'' (through ``3''), and ``4--1''  processes,  since
        these encompass the farthermost end states that uniformly and  continually  embrace  the
        stated defining conditions (a), (b), and (c).
    \end{example}
