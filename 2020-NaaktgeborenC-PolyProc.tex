...
\section{Conclusions}
    ...
    The concept of a \emph{logical thermodynamic process}, which is a  process  with  restricted
    end states, has been laid out by Definition~\ref{def:logical.proc}. With logical process, or
    logical conditions, processes and  associated  end  states  can  be  uniquely  referred  to.
    Example~\ref{ex:ideal.Diesel} works out the concept.

    The concept of \emph{exact polytropic process},  which  is  both  logical,  polytropic,  and
    non-reversal,  see  Lemma~\ref{lemm:no.reversal}   as   well,   has   been   laid   out   in
    Section~\ref{sec:exact}.  A  `Cycle'  theorem  relating  to  exact   polytropic   processes,
