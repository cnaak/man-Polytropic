...
\Archive{\today}                    % TODO: Latest upload date
% Article title
\PaperTitle{On Exact and Local Polytropic Processes -- Requisites, Etymology, and Modeling}
...
\Remarks{%
    ...
    brings new definition for \emph{local polytropic process} ---
...
\section*{License and Release Date}
    ...
    \begin{minipage}{\columnwidth}
        ...
        {\scriptsize\url{https://creativecommons.org/licenses/by-nc-nd/4.0/}}\\[0.5\smallskipamount]
