...
\section{Requisites for Exact Polytropic Processes}
    ...
    application; $u$ is the system specific internal energy, and $e = e_k + e_p$ is the  sum  of
    system specific macroscopic energies, with $e_k$ and $e_p$ being the  specific  kinetic  and
    potential energies, respectively. Neglecting the variation of the system macroscopic  energy
    forms, simplifies Equation~(\ref{eq:1st.law.int.diff.micro.macro}), giving:
    %
    \begin{align}
