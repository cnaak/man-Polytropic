...
\section{Requisites for Exact Polytropic Processes}
    ...
    heats, respectively---in order to arrive at a polytropic relation between $P$ and  $v$,  and
    continues the analysis with a $Pv = ZRT$ equation of state with the assumption  of  constant
    $Z$.
