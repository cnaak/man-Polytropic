...
\section{Exact and Local Polytropic Processes}
    ...
    \emph{cycles} can be trivially subdivided  into  the  process  set  stated  on  the  general
    approximability conjecture, since (sub-)process end states can be arbitrarily placed  within
    the larger cycle path.
