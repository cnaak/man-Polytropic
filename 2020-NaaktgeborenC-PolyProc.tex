...
\section{Exact and Local Polytropic Processes}
    ...
    polytropic processes, additional constraints need to be made to the process end states.

    Therefore, the extent of a process that is candidate for being deemed as an exact polytropic
    one is such that \emph{the defining conditions of the process apply uniformly throughout the
    entirety of the proceess}.
