...
\section{Exact and Local Polytropic Processes}
    ...
    \begin{definition}[local polytropic process]\label{def:local.polytropic}
        ...
        of or another process, to within suitable error intervals, and shares its two end states
        with it.
    \end{definition}
    ...
    \begin{conjecture}[general approximability]\label{conj:gen.approx}
        Any continuous, quasi-equilibrium process set can  be  approximated,  to  within  finite
        error intervals, by a finite set of local polytropic processes.
    \end{conjecture}
    ...
    general approximability conjecture.
